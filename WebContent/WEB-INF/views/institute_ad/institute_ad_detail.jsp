 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_INSTITUTE_AD )의 상세보기/목록/수정/삭제
 ***************************************************************************************************/
%>
...
$(function() {
     ...
     */
  	$("#btn_list").click(function() {
		$("#frm").attr("action", "/institute_ad/institute_ad_list.do");
		$("#frm").submit();
	});
	...
	$("#btn_modify").click(function() {
		...
		$("#frm").attr("action", "/institute_ad/institute_ad_form.do");
		$("#frm").submit();
	});
	...
	$("#btn_delete").click(function() {
		...
		$.ajax({
	    	url		: "<c:url value='/institute_ad/institute_ad_delete.do'/>",
	        type	: "POST",
	        data	: $("#frm").serialize(),
	        dataType: "text",
