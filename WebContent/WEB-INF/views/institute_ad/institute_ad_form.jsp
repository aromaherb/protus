...
<%
/***************************************************************************************************
 * 파일명 : institute_ad_form.jsp
 * 작성자 : 장재현 (jang1945@raonsolution.co.kr)
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_INSTITUTE_AD )의 입력 및 수정 form출력/저장/취소/입력 값 검증
 ***************************************************************************************************/
%>
...
$(function() {
	...
	$("#btn_save").click(function() {
	    ...
	    $.ajax({
	    	url		: "<c:url value='/institute_ad/institute_ad_save.do'/>",
	        type	: "POST",
     ...
     */
  	$("#btn_list").click(function() {
		$("#formEdit").attr("action", "/institute_ad/institute_ad_list.do");
		$("#formEdit").submit();
	});
}); 

/**
 * ( TB_INSTITUTE_AD ) 입력 값 검증
 */
function verifyForm() {	
...
<!-- 목록 이동 폼 -->
<form id="formList" name="formList" class="inline" method="post" action="institute_ad_list.do">
...
<table class="table02">
		...
		<tr>
			<th>슬로건</th>
			<td><input type="text" name="institute_slogan" size="100" value="${entity.INSTITUTE_SLOGAN}"></td>
		</tr>		 
