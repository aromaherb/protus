...
$(function() {
     ...
     */
  	$("#btn_list").click(function() {
		$("#frm").attr("action", "/notice/notice_list.do");
		$("#frm").submit();
	});
	...
	$("#btn_modify").click(function() {
		...
		$("#frm").attr("action", "/notice/notice_form.do");
		$("#frm").submit();
	});
	...
	$("#btn_delete").click(function() {
		...
		$.ajax({
	    	url		: "<c:url value='/notice/notice_delete.do'/>",
	        type	: "POST",
	        data	: $("#frm").serialize(),
	        dataType: "text",
...
<div class="content">
	...
	<div class="tab_con">
		...
		<!-- 표 이동 버튼 -->
		<ul class="send_in">
			<li class="write_button"><input id="btn_list" type="button" value="목록으로" onclick="location.href='/notice/notice_list.do'"></li>
			<li class="cancle_button"><input id="btn_modify" type="button" value="수정하기" onclick="location.href='/notice/notice_form.do'"></li>
