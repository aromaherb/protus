 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_INSTITUTE_TEACHER )의 상세보기/목록/수정/삭제
 ***************************************************************************************************/
%>
...
$(function() {
     ...
     */
  	$("#btn_list").click(function() {
		$("#frm").attr("action", "/institute_teacher/institute_teacher_list.do");
		$("#frm").submit();
	});
	...
	$("#btn_modify").click(function() {
		...
		$("#frm").attr("action", "/institute_teacher/institute_teacher_form.do");
		$("#frm").submit();
	});
	...
	$("#btn_delete").click(function() {
		...
		$.ajax({
	    	url		: "<c:url value='/institute_teacher/institute_teacher_delete.do'/>",
	        type	: "POST",
	        data	: $("#frm").serialize(),
	        dataType: "text",
...
<div id="con_tit">
	...
	<form id="frm" name="frm" method="post">
		...
		<input type="hidden" name="etc" value="${entity.ETC}"/>
	</form>
	<!-- //이동 폼-->
	<!-- 컨텐츠 본문-->
	<div id="content">
