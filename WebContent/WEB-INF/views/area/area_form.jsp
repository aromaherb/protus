 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_AREA )의 입력 및 수정 form출력/저장/취소/입력 값 검증
 ***************************************************************************************************/
%>
...
$(function() {
	...
	$("#btn_save").click(function() {
	    ...
	    $.ajax({
	    	url		: "<c:url value='/area/area_save.do'/>",
	        type	: "POST",
     ...
     */
  	$("#btn_list").click(function() {
		$("#formEdit").attr("action", "/area/area_list.do");
		$("#formEdit").submit();
	});
}); 
 ...
 */
function verifyForm() {	
	if(Valid.isEmpty($("input[name=area_cd]").val())) {
		alert("지역코드 는 필수입력 항목입니다.");
		return false;
	}
	return true;
}
...
<!-- 목록 이동 폼 -->
<form id="formList" name="formList" class="inline" method="post" action="area_list.do">
...
<table class="table02">
		...
		<tr>
			<th>지역명</th>
			<td><input type="text" name="area_name" size="100" value="${entity.AREA_NAME}"></td>
		</tr>		 
