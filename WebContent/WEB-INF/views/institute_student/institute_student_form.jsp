 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_INSTITUTE_STUDENT )의 입력 및 수정 form출력/저장/취소/입력 값 검증
 ***************************************************************************************************/
%>
...
$(function() {
	...
	/**
	 * ( TB_INSTITUTE_STUDENT ) 저장
	 */
	$("#btn_save").click(function() {
	    if( verifyForm() == false) return;
	    
	    $.ajax({
	    	url		: "<c:url value='/institute_student/institute_student_save.do'/>",
	        type	: "POST",
     ...
     */
  	$("#btn_list").click(function() {
		$("#formEdit").attr("action", "/institute_student/institute_student_list.do");
		$("#formEdit").submit();
	});
}); 

/**
 * ( TB_INSTITUTE_STUDENT ) 입력 값 검증
 */
function verifyForm() {	
...
<!-- 목록 이동 폼 -->
<form id="formList" name="formList" class="inline" method="post" action="institute_student_list.do">
