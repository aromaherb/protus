 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_EMAIL_APPROVE )의 상세보기/목록/수정/삭제
 ***************************************************************************************************/
%>
...
$(function() {
     ...
     */
  	$("#btn_list").click(function() {
		$("#frm").attr("action", "/email_approve/email_approve_list.do");
		$("#frm").submit();
	});
	...
	$("#btn_modify").click(function() {
		...
		$("#frm").attr("action", "/email_approve/email_approve_form.do");
		$("#frm").submit();
	});
	...
	$("#btn_delete").click(function() {
		...
		$.ajax({
	    	url		: "<c:url value='/email_approve/email_approve_delete.do'/>",
	        type	: "POST",
	        data	: $("#frm").serialize(),
	        dataType: "text",
