...
<%
/***************************************************************************************************
 * 파일명 : email_approve_form.jsp
 * 작성자 : 장재현 (jang1945@raonsolution.co.kr)
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_EMAIL_APPROVE )의 입력 및 수정 form출력/저장/취소/입력 값 검증
 ***************************************************************************************************/
%>
...
$(function() {
	...
	$("#btn_save").click(function() {
	    ...
	    $.ajax({
	    	url		: "<c:url value='/email_approve/email_approve_save.do'/>",
	        type	: "POST",
     ...
     */
  	$("#btn_list").click(function() {
		$("#formEdit").attr("action", "/email_approve/email_approve_list.do");
		$("#formEdit").submit();
	});
}); 

/**
 * ( TB_EMAIL_APPROVE ) 입력 값 검증
 */
function verifyForm() {	
...
<!-- 목록 이동 폼 -->
<form id="formList" name="formList" class="inline" method="post" action="email_approve_list.do">
...
<p class="jump_menu">TB_EMAIL_APPROVE 관리 &gt <b>TB_EMAIL_APPROVE 관리</b></p>
</div>
...
<table class="table02">
		...
		<tr>
			<th>요청일자</th>
			<td><input type="text" name="request_date" size="100" value="${entity.REQUEST_DATE}"></td>
		</tr>		
		<tr>
			<th>승인일자</th>
		...
		<tr>
			<th>이메일</th>
			<td><input type="text" name="email" size="100" value="${entity.EMAIL}"></td>
		</tr>		 
