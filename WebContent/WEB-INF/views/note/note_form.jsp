 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_NOTE )의 입력 및 수정 form출력/저장/취소/입력 값 검증
 ***************************************************************************************************/
%>
...
$(function() {
	...
	$("#btn_save").click(function() {
	    ...
	    $.ajax({
	    	url		: "<c:url value='/note/note_save.do'/>",
	        type	: "POST",
     ...
     */
  	$("#btn_list").click(function() {
		$("#formEdit").attr("action", "/note/note_list.do");
		$("#formEdit").submit();
	});
}); 
 ...
 */
function verifyForm() {	
	if(Valid.isEmpty($("input[name=note_seq]").val())) {
		alert("쪽지 번호 는 필수입력 항목입니다.");
		return false;
	}
	return true;
}
...
<!-- 목록 이동 폼 -->
<form id="formList" name="formList" class="inline" method="post" action="note_list.do">
...
<table class="table02">
		...
		<tr>
			<th>쪽지 번호</th>
			<td><input type="text" name="note_seq" size="100" value="${entity.NOTE_SEQ}"></td>
		</tr>		
		<tr>
			<th>보낸이</th>
		...
		<tr>
			<th>받는이</th>
			<td><input type="text" name="receiver_seq" size="100" value="${entity.RECEIVER_SEQ}"></td>
		</tr>		
		<tr>
			<th>읽기여부</th>
			<td><input type="text" name="open_yn" size="100" value="${entity.OPEN_YN}"></td>
		</tr>		
		<tr>
			<th>쪽지내용</th>
			<td><input type="text" name="note_subject" size="100" value="${entity.NOTE_SUBJECT}"></td>
		</tr>		
		<tr>
			<th>답장내용</th>
			<td><input type="text" name="reply_subject" size="100" value="${entity.REPLY_SUBJECT}"></td>
		</tr>		
		<tr>
			<th>답장여부</th>
			<td><input type="text" name="reply_yn" size="100" value="${entity.REPLY_YN}"></td>
		</tr>		
		<tr>
			<th>쪽지일시</th>
			<td><input type="text" name="note_dt" size="100" value="${entity.NOTE_DT}"></td>
		</tr>		
		<tr>
			<th>답장일시</th>
