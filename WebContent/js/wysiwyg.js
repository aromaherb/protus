...
function createELM(){
	...
	for (var i=0;i<textareaName.length;i++){
		...
		ctrlObj += " 	<img src=\"/editor_images/ed_fontface.gif\" border=\"0\" alt=\"글꼴\" onClick=\"viewLayer('"+i+"', 'fontfaceLayer"+i+"');\"> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_fontsize.gif\" border=\"0\" alt=\"크기\" onClick=\"viewLayer('"+i+"', 'fontsizeLayer"+i+"');\"> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('bold', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_bold.gif\" border=\"0\" alt=\"두꺼운체\"></A> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('italic', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_italic.gif\" border=\"0\" alt=\"기울림체\"></A> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('underline', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_underline.gif\" border=\"0\" alt=\"밑줄\"></A> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('StrikeThrough', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_strike.gif\" border=\"0\" alt=\"취소선\"></A> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_color_fg.gif\" border=\"0\" alt=\"글자색상\" onClick=\"viewLayer('"+i+"', 'fgLayer"+i+"');\"> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_color_bg.gif\" border=\"0\" alt=\"글자색상\" onClick=\"viewLayer('"+i+"', 'bgLayer"+i+"');\"> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('justifyleft', false, null, '"+i+"');\"><img src=\"/editor_images/ed_align_left.gif\" border=\"0\" alt=\"좌측정렬\"></a> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('justifycenter', false, null, '"+i+"');\"><img src=\"/editor_images/ed_align_center.gif\" border=\"0\" alt=\"중심정렬\"></a> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('justifyright', false, null, '"+i+"');\"><img src=\"/editor_images/ed_align_right.gif\" border=\"0\" alt=\"우측정렬\"></a> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('insertorderedlist', false, null), '"+i+"';\"><img src=\"/editor_images/ed_list_number.gif\" border=\"0\" alt=\"숫자목록\"></a> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('insertunorderedlist', false, null, '"+i+"');\"><img src=\"/editor_images/ed_list_dot.gif\" border=\"0\" alt=\"점표시목록\"></a> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('outdent', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_outdent.gif\" border=\"0\" alt=\"들여쓰기줄이기\"></a> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('indent', false, null, '"+i+"');\"><img src=\"/editor_images/ed_format_indent.gif\" border=\"0\" alt=\"들여쓰기늘이기\"></a> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('InsertHorizontalRule', false, null, '"+i+"');\"><img src=\"/editor_images/ed_hr.gif\" border=\"0\" alt=\"한줄넣기\"></a> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<A href=\"javascript:htmledit('removeformat', false, null, '"+i+"');\"><img src=\"/editor_images/ed_reset.gif\" border=\"0\" alt=\"꾸밈 초기화\"></a> ";
		ctrlObj += " 	<img src=\"/editor_images/ed_virtical.gif\"> ";
		ctrlObj += " 	<img id=\"viewEdirorBtn"+i+"\" src=\"/editor_images/ed_editor.gif\" border=\"0\" alt=\"편집화면\" style=\"display:none\" onClick=\"viewEdiror('iframe"+textareaName[i]+"','"+textareaName[i]+"', '"+i+"');\"> ";
		ctrlObj += " 	<img id=\"viewSourceBtn"+i+"\" src=\"/editor_images/ed_html.gif\" border=\"0\" alt=\"소스보기\" style=\"display:inline\" onClick=\"viewSource('iframe"+textareaName[i]+"','"+textareaName[i]+"', '"+i+"');\"> ";
		ctrlObj += " 	<br> ";
