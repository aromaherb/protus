 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_EVENT )의 콘트롤러 목록/상세정보/Form 상세정보/입력/수정/삭제/전체삭제 
 ***************************************************************************************************/
...
public class EventController extends BaseController {
	...
	public String event_list(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		try {
			mapper.setSqlMapper("Event");     // 매핑 선언
            ...
            logger.error("Event 목록");
            logger.error(e.getMessage());
		} finally {
            //
		}
		return "event/event_list.admin_main";
	}
	 ...
	 * @return			tiles 템플릿
	 */
	@RequestMapping(value = "/event/event_form.do")
	public String event_form(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		String method = StringUtil.object2Str(params.get("method"));
		
		String event_seq = StringUtil.object2Str(params.get("event_seq")); 
		...
		try {
			...
			logger.error("Event Form 정보");
            logger.error(e.getMessage());
		} finally {
			//
		}
		if(method.equals("V")) {
			return "event/event_detail.admin_main";
		}else {
			return "event/event_form.admin_main";
		}
	}
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/event/event_save.do")
    @ResponseBody
    public Map<String, Object> event_save(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        String method = StringUtil.object2Str(params.get("method"));
		if(method.equals("A")) {
			return event_insert(params,request,model);
		}else {
			return event_update(params,request,model);
		}
    }
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/base/event_insert.do")
    @ResponseBody
    public Map<String, Object> event_insert(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/event/event_update.do")
    @ResponseBody
    public Map<String, Object> event_update(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        Map<String, Object> result = new HashMap<String, Object>();
   ...
   /**
    ...
    @ResponseBody
    public Map<String, Object> event_delete(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        Map<String, Object> result = new HashMap<String, Object>();
	...
	/**
	 * ( TB_EVENT ) 입력/수정/삭제/삭제'Y'/삭제'N'/전체삭제
	 * @param params	인자
	 * @param model		모델
	 * @return			결과 상태 값
	 */	
	@RequestMapping(value = "/base/event_process.do")
	@ResponseBody
	public Map<String, Object> event_process(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		// 결과 상태값 셋팅
		Map<String, Object> result = new HashMap<String, Object>();
		...
		try {
            ...
            logger.error("Event 입력/수정/삭제/삭제'Y'/삭제'N'/전체삭제");
            logger.error(e.getMessage());			
		} finally {
		    //
		}
