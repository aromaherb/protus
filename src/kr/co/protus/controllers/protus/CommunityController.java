 ...
 * 작성일 : 2016-8-19
 * 내  용 : ( TB_COMMUNITY )의 콘트롤러 목록/상세정보/Form 상세정보/입력/수정/삭제/전체삭제 
 ***************************************************************************************************/
...
public class CommunityController extends BaseController {
	...
	public String community_list(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		try {
			mapper.setSqlMapper("Community");     // 매핑 선언
            ...
            logger.error("Community 목록");
            logger.error(e.getMessage());
		} finally {
            //
		}
		return "community/community_list.admin_main";
	}

	/**
	 * ( TB_COMMUNITY ) Form 정보
	 * @param params	인자
	 * @param model		모델
	 * @return			tiles 템플릿
	 */
	@RequestMapping(value = "/community/community_form.do")
	public String community_form(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		...
		try {
			...
			logger.error("Community Form 정보");
            logger.error(e.getMessage());
		} finally {
			//
		}
		if(method.equals("V")) {
			return "community/community_detail.admin_main";
		}else {
			return "community/community_form.admin_main";
		}
	}
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/community/community_save.do")
    @ResponseBody
    public Map<String, Object> community_save(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        String method = StringUtil.object2Str(params.get("method"));
		if(method.equals("A")) {
			return community_insert(params,request,model);
		}else {
			return community_update(params,request,model);
		}
    }
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/base/community_insert.do")
    @ResponseBody
    public Map<String, Object> community_insert(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
     ...
     * @return          결과 상태 값
     */ 
    @RequestMapping(value = "/community/community_update.do")
    @ResponseBody
    public Map<String, Object> community_update(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        Map<String, Object> result = new HashMap<String, Object>();
   ...
   /**
    ...
    @ResponseBody
    public Map<String, Object> community_delete(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
        // 결과 상태값 셋팅
        Map<String, Object> result = new HashMap<String, Object>();
	...
	/**
	 * ( TB_COMMUNITY ) 입력/수정/삭제/삭제'Y'/삭제'N'/전체삭제
	 * @param params	인자
	 * @param model		모델
	 * @return			결과 상태 값
	 */	
	@RequestMapping(value = "/base/community_process.do")
	@ResponseBody
	public Map<String, Object> community_process(@RequestParam Map<String, Object> params, HttpServletRequest request, Model model) {
		// 결과 상태값 셋팅
		Map<String, Object> result = new HashMap<String, Object>();
		...
		try {
            ...
            logger.error("Community 입력/수정/삭제/삭제'Y'/삭제'N'/전체삭제");
            logger.error(e.getMessage());			
		} finally {
		    //
		}
